...
if(!dir.exists('figures/supplement-5-scenario-3')){
  dir.create('figures/supplement-5-scenario-3')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-5-scenario-3/')
```
...
A baseline inclusion threshold of 0 on an 11-point NRS (i.e., no inclusion threshold) was used as a "control". In addition to the control threshold, three baseline pain intensity inclusion thresholds were selected based on the data listed in the supplementary materials of Finnerup and colleagues$^1$. The three thresholds were: pain intensity $\geq$ 4 (71% of listed studies), pain intensity $\geq$ 3 (12% of listed studies), and pain intensity $\geq$ 5 (11% of listed studies). Data from the three simulated datasets (mean = 6.2, SD = 1.7, correlation = 0.26, 0.37, 0.51) were each modelled under each of the four baseline pain intensity inclusion thresholds. 
...
shift_A <- cor_026V1.df %>% 
  ...
  labs(title = 'Scenario 3A',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity',
       subtitle = 'Threshold 0: V1 = 6.0 (1.8), V2 = 6.0 (1.9), r = 0.19') +
...
shift_B <- cor_037V1.df %>% 
  ...
  labs(title = 'Scenario 3B',
       subtitle = 'Threshold 0: V1 = 6.0 (1.8), V2 = 5.9 (1.9), r = 0.3',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(5, 10)) +
...
shift_C <- cor_051V1.df %>% 
  ...
  labs(title = 'Scenario 3C',
       subtitle = 'Threshold 0: V1 = 6.0 (1.8), V2 = 5.9 (1.9), r = 0.43',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(5, 10)) +

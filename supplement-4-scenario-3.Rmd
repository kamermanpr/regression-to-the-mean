---
title: "Supplement 4: Scenario 3"
subtitle: "Mean pain intensity of 6.2 (SD 2.0) at 0.26, 0.37, and 0.51 inter-measurement correlation"
...
if(!dir.exists('figures/supplement-4-scenario-3')){
  dir.create('figures/supplement-4-scenario-3')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-4-scenario-3/')
```
...
- _r_ = 0.26 (Scenario 3A)

- _r_ = 0.37 (Scenario 3B)

- _r_ = 0.51 (Scenario 3C)
...
# Scenario 3A: Inter-measurement correlation = 0.26
...
ggMarginal(ggplot(data = cor_026.base) +
               ...
               labs(title = 'Scenario 3A: Unconstained',
...
ggMarginal(ggplot(data = cor_026) +
               ...
               labs(title = 'Scenario 3A: Constrained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggplot(data = cor_026V1.df) +
    ...
    labs(title = 'Scenario 3A: Shift in V1 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
...
ggplot(data = cor_026V2.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 3A: Shift in V2 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*') 
```
...
ggMarginal(placebo_1.0[, 1:3] %>% 
               ...
               labs(title = 'Scenario 3A: Pain inclusion threshold = 0',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
...
ggMarginal(placebo_1.3[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 3A: Pain inclusion threshold = 3',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_1.4[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 3A: Pain inclusion threshold = 4',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_1.5[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 3A: Pain inclusion threshold = 5',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
shift_A <- cor_026V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(title = 'Scenario 3A',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity',
       subtitle = 'Threshold 0:\nBASELINE = 6.0 (1.8), ENDPOINT = 6.0 (1.9), r = 0.19') +
...
# Scenario 3B: Inter-measurement correlation = 0.37
...
ggMarginal(ggplot(data = cor_037.base) +
               ...
               labs(title = 'Scenario 3B: Unconstained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggMarginal(ggplot(data = cor_037) +
               ...
               labs(title = 'Scenario 3B: Constrained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggplot(data = cor_037V1.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 3B: Shift in V1 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*') 
```
...
ggplot(data = cor_037V2.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 3B: Shift in V2 mean pain intensity',
...
ggMarginal(placebo_2.0[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 3B: Pain inclusion threshold = 0',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_2.3[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 3B: Pain inclusion threshold = 3',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_2.4[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 3B: Pain inclusion threshold = 4',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_2.5[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 3B: Pain inclusion threshold = 5',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
shift_B <- cor_037V1.df %>% 
  ...
  aes(y = mean,
      x = cutoff2,
      fill= time) +
  geom_hline(yintercept = 5.97,
             linetype = 2) +
  geom_point(shape = 21,
             size = 8) +
  labs(title = 'Scenario 3B',
       subtitle = 'Threshold 0:\nBASELINE = 6.0 (1.8), ENDPOINT = 5.9 (1.9), r = 0.3',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
...
# Scenario 3C: Inter-measurement correlation = 0.51
...
ggMarginal(ggplot(data = cor_051.base) +
               ...
               labs(title = 'Scenario 3C: Unconstained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggplot(data = cor_051V1.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 3C: Shift in V1 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*')
```
...
ggplot(data = cor_051V2.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 3C: Shift in V2 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*') 
```
...
ggMarginal(placebo_3.0[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 3C: Pain inclusion threshold = 0',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_3.3[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 3C: Pain inclusion threshold = 3',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_3.4[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 3C: Pain inclusion threshold = 4',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_3.5[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 3C: Pain inclusion threshold = 5',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
shift_C <- cor_051V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(title = 'Scenario 3C',
       subtitle = 'Threshold 0:\nBASELINE = 6.0 (1.8), ENDPOINT = 5.9 (1.9), r = 0.43',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
  scale_x_continuous(breaks = 0:3,
                     labels = c(0, 3, 4, 5)) +
...
shift_A2 <- cor_026V1.df %>% 
  ...
  geom_point(shape = 21,
             ...
             stroke = 0.8) +
  labs(title = 'Scenario 3A',
       x = 'Baseline inclusion threshold',
       y = 'Mean pain intensity',
       subtitle = 'Threshold 0:\nBASELINE = 6.0 (1.8)\nENDPOINT = 6.0 (1.9), r = 0.19') +
  scale_x_continuous(breaks = c(0, 1, 2, 3),
                     labels = c(0, 3, 4, 5)) +
  scale_y_continuous(limits = c(5, 10)) +
  scale_fill_manual(labels = c('BASELINE', 'ENDPOINT'),
...
shift_C2 <- cor_051V1.df %>% 
  ...
  geom_point(shape = 21,
             ...
             stroke = 0.8) +
  labs(title = 'Scenario 3C',
       subtitle = 'Threshold 0:\nBASELINE = 6.0 (1.8)\nENDPOINT = 5.9 (1.9), r = 0.43',
       x = 'Baseline pain threshold',
       y = NULL) +
  scale_x_continuous(breaks = 0:3,
                     labels = c(0, 3, 4, 5)) +
  scale_y_continuous(limits = c(5, 10)) +
...
ggsave(filename = 'figures/figure-scenario-3-baseline-shift.png',
       plot = shifts,
       height = 7.9, 
       width = 21)
...
ggsave(filename = 'figures/figure-scenario-3-V1V2-difference.png',
       plot = diffs,
       height = 7.9, 
       width = 21)
```

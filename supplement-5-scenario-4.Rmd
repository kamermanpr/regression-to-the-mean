---
title: "Supplement 6: Scenario 4"
subtitle: "Mean pain intensity of 5.7 (SD 1.7) at 0.26, 0.37, and 0.51 inter-measurement correlation"
...
if(!dir.exists('figures/supplement-6-scenario-4')){
  dir.create('figures/supplement-6-scenario-4')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-6-scenario-4/')
```
...
A baseline inclusion threshold of 0 on an 11-point NRS (i.e., no inclusion threshold) was used as a "control". In addition to the control threshold, three baseline pain intensity inclusion thresholds were selected based on the data listed in the supplementary materials of Finnerup and colleagues$^1$. The three thresholds were: pain intensity $\geq$ 4 (71% of listed studies), pain intensity $\geq$ 3 (12% of listed studies), and pain intensity $\geq$ 5 (11% of listed studies). Data from the three simulated datasets (mean = 5.7, SD = 1.7, correlation = 0.26, 0.37, 0.51) were each modelled under each of the four baseline pain intensity inclusion thresholds. 
...
- _r_ = 0.26 (Scenario 4A)

- _r_ = 0.37 (Scenario 4B)

- _r_ = 0.51 (Scenario 4C)
...
# Scenario 4A: Inter-measurement correlation = 0.26
...
# Generate the data
cor_026.base <- as.data.frame(mvrnorm(n = 1000, mu = c(5.7, 5.7), Sigma = cov_026))
...
ggMarginal(ggplot(data = cor_026.base) +
               ...
               labs(title = 'Scenario 4A: Unconstained',
...
ggMarginal(ggplot(data = cor_026) +
               ...
               labs(title = 'Scenario 4A: Constrained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggplot(data = cor_026V1.df) +
    ...
    labs(title = 'Scenario 4A: Shift in V1 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
...
ggplot(data = cor_026V2.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 4A: Shift in V2 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*') 
```
...
ggMarginal(placebo_1.0[, 1:3] %>% 
               ...
               labs(title = 'Scenario 4A: Pain inclusion threshold = 0',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
...
ggMarginal(placebo_1.3[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 4A: Pain inclusion threshold = 3',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_1.4[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 4A: Pain inclusion threshold = 4',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_1.5[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 4A: Pain inclusion threshold = 5',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
shift_A <- cor_026V1.df %>% 
  ...
  aes(y = mean,
      x = cutoff2,
      fill= time) +
  geom_hline(yintercept = 5.59,
             linetype = 2) +
  geom_point(shape = 21,
             size = 8) +
  labs(title = 'Scenario 4A',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity',
       subtitle = 'Threshold 0: V1 = 5.6 (1.7), V2 = 5.6 (1.7), r = 0.23') +
...
# Scenario 4B: Inter-measurement correlation = 0.37
...
# Generate the data
cor_037.base <- as.data.frame(mvrnorm(n = 1000, mu = c(5.7, 5.7), Sigma = cov_037))
...
ggMarginal(ggplot(data = cor_037.base) +
               ...
               labs(title = 'Scenario 4B: Unconstained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggMarginal(ggplot(data = cor_037) +
               ...
               labs(title = 'Scenario 4B: Constrained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggplot(data = cor_037V1.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 4B: Shift in V1 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*') 
```
...
ggplot(data = cor_037V2.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 4B: Shift in V2 mean pain intensity',
         caption = 'Population parameters: Mean = 5.7, SD = 1.7, r = 0.37',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*')
```
...
ggMarginal(placebo_2.0[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 4B: Pain inclusion threshold = 0',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_2.3[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 4B: Pain inclusion threshold = 3',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_2.4[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 4B: Pain inclusion threshold = 4',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_2.5[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 4B: Pain inclusion threshold = 5',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
shift_B <- cor_037V1.df %>% 
  ...
  aes(y = mean,
      x = cutoff2,
      fill= time) +
  geom_hline(yintercept = 5.58,
             linetype = 2) +
  geom_point(shape = 21,
             size = 8) +
  labs(title = 'Scenario 4B',
       subtitle = 'Threshold 0: V1 = 5.6 (1.7), V2 = 5.6 (1.7), r = 0.33',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(5, 10)) +
...
# Scenario 4C: Inter-measurement correlation = 0.51
...
# Generate the data
cor_051.base <- as.data.frame(mvrnorm(n = 1000, mu = c(5.7, 5.7), Sigma = cov_051))
...
ggMarginal(ggplot(data = cor_051.base) +
               ...
               labs(title = 'Scenario 4C: Unconstained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggplot(data = cor_051V1.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 4C: Shift in V1 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*')
```
...
ggplot(data = cor_051V2.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 4C: Shift in V2 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*')
```
...
ggMarginal(placebo_3.0[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 4C: Pain inclusion threshold = 0',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_3.3[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 4C: Pain inclusion threshold = 3',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_3.4[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 4C: Pain inclusion threshold = 4',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_3.5[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 4C: Pain inclusion threshold = 5',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
shift_C <- cor_051V1.df %>% 
  ...
  aes(y = mean,
      x = cutoff2,
      fill= time) +
  geom_hline(yintercept = 5.57,
             linetype = 2) +
  geom_point(shape = 21,
             size = 8) +
  labs(title = 'Scenario 4C',
       subtitle = 'Threshold 0: V1 = 5.6 (1.7), V2 = 5.6 (1.6), r = 0.47',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(5, 10)) +
...
ggsave(filename = 'figures/figure-scenario-4-baseline-shift.png',
       plot = shifts,
       height = 7, 
       width = 21)
...
ggsave(filename = 'figures/figure-scenario-4-V1V2-difference.png',
       plot = diffs,
       height = 7, 
       width = 21)
```

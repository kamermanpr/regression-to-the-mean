---
title: "Supplement 6: Secondary analysis A"
subtitle: "Mean pain rating of 3.7 (SD 1.7) at 0.26, 0.37, and 0.51 inter-measurement correlation"
...
if(!dir.exists('figures/supplement-6-secondary-analysis-A')){
  dir.create('figures/supplement-6-secondary-analysis-A')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-6-secondary-analysis-A/')
```
...
ggMarginal(ggplot(data = cor_026.base) +
               ...
               labs(title = 'A: Unconstained',
                    caption = 'Population parameters: Mean = 3.7, SD = 1.7, r = 0.26') +
...
shift_A <- cor_026V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(subtitle = 'Population parameters: Mean = 3.7, SD = 1.7, r = 0.26',
       x = 'Baseline pain intensity inclusion threshold',
...
ggMarginal(ggplot(data = cor_037.base) +
               ...
               labs(title = 'A: Unconstained',
                    caption = 'Population parameters: Mean = 3.7, SD = 1.7, r = 0.37') +
               scale_y_continuous(limits = c(-5, 15),
                                  breaks = c(0, 5, 10)) +
               scale_x_continuous(limits = c(-5, 15),
                                  breaks = c(0, 5, 10)) +
...
shift_B <- cor_037V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(subtitle = 'Population parameters: Mean = 3.7, SD = 1.7, r = 0.37',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain score (0-10 rating scale)') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(3, 10)) +
...
ggMarginal(ggplot(data = cor_051.base) +
               ...
               labs(title = 'A: Unconstained',
                    caption = 'Population parameters: Mean = 3.7, SD = 1.7, r = 0.51') +
               scale_y_continuous(limits = c(-5, 15),
                                  breaks = c(0, 5, 10)) +
               scale_x_continuous(limits = c(-5, 15),
                                  breaks = c(0, 5, 10)) +
...
shift_C <- cor_051V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(subtitle = 'Population parameters: Mean = 3.7, SD = 1.7, r = 0.51',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain score (0-10 rating scale)') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(3, 10)) +
...
ggsave(filename = 'figures/figure-baseline-shift-2A.png',
       plot = shifts,
       height = 7, 
       width = 21)
...
ggsave(filename = 'figures/figure-V1V2-difference-2A.png',
       plot = diffs,
       height = 7, 
       width = 21)
```

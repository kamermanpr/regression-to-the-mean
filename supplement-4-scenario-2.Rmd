...
if(!dir.exists('figures/supplement-4-scenario-2')){
  dir.create('figures/supplement-4-scenario-2')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-4-scenario-2/')
```
...
shift_A <- cor_026V1.df %>% 
  ...
  labs(title = 'Scenario 2A',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity',
       subtitle = 'Threshold 0: V1 = 6.1 (1.4), V2 = 6.1 (1.4), r = 0.23') +
...
shift_B <- cor_037V1.df %>% 
  ...
  labs(title = 'Scenario 2B',
       subtitle = 'Threshold 0: V1 = 6.1 (1.4), V2 = 6.1 (1.4), r = 0.34',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(5, 10)) +
...
shift_C <- cor_051V1.df %>% 
  ...
  labs(title = 'Scenario 2C',
       subtitle = 'Threshold 0: V1 = 6.1 (1.4), V2 = 6.1 (1.4), r = 0.49',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity*') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(5, 10)) +
...
diff_C <- diff_all_1 %>% 
  ...
  geom_point(shape = 21,
             ...
             size = 8) +
  labs(title = 'Scenario 2C',
       caption = 'Threshold 0: V1 = 6.1 (1.4), V2 = 6.1 (1.4), r = 0.49',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean difference (V1 - V2)') +

---
title: "Supplement 3: Primary analysis 1C"
subtitle: "Mean pain rating of 6.2 (SD 2.9) at 0.26, 0.37, 0.51 correlation"
...
if(!dir.exists('figures/supplement-3-primary-analysis-1C')){
  dir.create('figures/supplement-3-primary-analysis-1C')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-3-primary-analysis-1C/')
```
...
ggsave(filename = 'figures/figure_2_shift1C.png',
       plot = shifts,
       height = 7, 
       width = 21)
...
ggsave(filename = 'figures/figure_2_diff1C.png',
       plot = diffs,
       height = 7, 
       width = 21)
```

---
title: "Supplement 4: Primary analysis B"
subtitle: "Mean pain rating of 6.2 (SD 0.8) at 0.26, 0.37, and 0.51 inter-measurement correlation"
...
if(!dir.exists('figures/supplement-4-primary-analysis-B')){
  dir.create('figures/supplement-4-primary-analysis-B')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-4-primary-analysis-B/')
```
...
A baseline inclusion threshold of 0 on an 11-point NRS (i.e., no inclusion threshold) was used as a "control". In addition to the control threshold, three baseline pain intensity inclusion thresholds were selected based on the data listed in the supplementary materials of Finnerup and colleagues$^1$. The three thresholds were: pain intensity $\geq$ 4 (71% of listed studies), pain intensity $\geq$ 3 (12% of listed studies), and pain intensity $\geq$ 5 (11% of listed studies). Data from the three simulated datasets (mean = 6.2, SD = 0.8, correlation = 0.26, 0.37, 0.51) were each modelled under each of the four baseline pain intensity inclusion thresholds. 
...
ggMarginal(ggplot(data = cor_026.base) +
               ...
               labs(title = 'A: Unconstained',
                    caption = 'Population parameters: Mean = 6.2, SD = 0.8, r = 0.26') +
...
shift_A <- cor_026V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(subtitle = 'Population parameters: Mean = 6.2, SD = 0.8, r = 0.26',
       x = 'Baseline pain intensity inclusion threshold',
...
ggMarginal(ggplot(data = cor_037.base) +
               ...
               labs(title = 'A: Unconstained',
                    caption = 'Population parameters: Mean = 6.2, SD = 0.8, r = 0.37') +
               scale_y_continuous(limits = c(-5, 15),
                                  breaks = c(0, 5, 10)) +
               scale_x_continuous(limits = c(-5, 15),
                                  breaks = c(0, 5, 10)) +
...
shift_B <- cor_037V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(subtitle = 'Population parameters: Mean = 6.2, SD = 0.8, r = 0.37',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain score (0-10 rating scale)') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(4, 10)) +
...
ggMarginal(ggplot(data = cor_051.base) +
               ...
               labs(title = 'A: Unconstained',
                    caption = 'Population parameters: Mean = 6.2, SD = 0.8, r = 0.51') +
               scale_y_continuous(limits = c(-5, 15),
                                  breaks = c(0, 5, 10)) +
               scale_x_continuous(limits = c(-5, 15),
                                  breaks = c(0, 5, 10)) +
...
shift_C <- cor_051V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(subtitle = 'Population parameters: Mean = 6.2, SD = 0.8, r = 0.51',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain score (0-10 rating scale)') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(4, 10)) +
...
ggsave(filename = 'figures/figure-baseline-shift-1B.png',
       plot = shifts,
       height = 7, 
       width = 21)
...
ggsave(filename = 'figures/figure-V1V2-difference-1B.png',
       plot = diffs,
       height = 7, 
       width = 21)
```

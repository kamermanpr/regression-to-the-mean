---
title: "Supplement 2: Scenario 1"
subtitle: "Mean pain intensity of 6.2 (SD 1.4) at 0.26, 0.37, and 0.51 inter-measurement correlation"
...
if(!dir.exists('figures/supplement-2-scenario-1')){
  dir.create('figures/supplement-2-scenario-1')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-2-scenario-1/')
```
...
A baseline inclusion threshold of 0 on an 11-point NRS (i.e., no inclusion threshold) was used as a "control". In addition to the control threshold, three baseline pain intensity inclusion thresholds were selected based on the data listed in the supplementary materials of Finnerup and colleagues$^1$. The three thresholds were: pain intensity $\geq$ 4 (71% of listed studies), pain intensity $\geq$ 3 (12% of listed studies), and pain intensity $\geq$ 5 (11% of listed studies). Data from the three simulated datasets (mean = 6.2, SD = 1.4, correlation = 0.26, 0.37, 0.51) were each modelled under each of the three baseline pain intensity inclusion thresholds, and when there was no threshold. 
...
Generate a covariance matrix using an SD of 1.4 and correlation of:

- _r_ = 0.26 (Scenario 1A)

- _r_ = 0.37 (Scenario 1B)

- _r_ = 0.51 (Scenario 1C)
...
# Scenario 1A: Inter-measurement correlation = 0.26
...
ggMarginal(ggplot(data = cor_026.base) +
               ...
               labs(title = 'Scenario 1A: Unconstained',
...
ggMarginal(ggplot(data = cor_026) +
               ...
               labs(title = 'Scenario 1A: Constrained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggplot(data = cor_026V1.df) +
    ...
    labs(title = 'Scenario 1A: Shift in V1 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
...
ggplot(data = cor_026V2.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 1A: Shift in V2 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*') 
```
...
ggMarginal(placebo_1.0[, 1:3] %>% 
               ...
               labs(title = 'Scenario 1A: Pain inclusion threshold = 0',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
...
ggMarginal(placebo_1.3[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 1A: Pain inclusion threshold = 3',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_1.4[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 1A: Pain inclusion threshold = 4',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_1.5[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 1A: Pain inclusion threshold = 5',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
shift_A <- cor_026V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(title = 'Scenario 1A',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity',
       subtitle = 'Threshold 0:\nBASELINE = 6.1 (1.4), ENDPOINT = 6.1 (1.4), r = 0.23') +
...
# Scenario 1B: Inter-measurement correlation = 0.37
...
ggMarginal(ggplot(data = cor_037.base) +
               ...
               labs(title = 'Scenario 1B: Unconstained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggMarginal(ggplot(data = cor_037) +
               ...
               labs(title = 'Scenario 1B: Constrained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggplot(data = cor_037V1.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 1B: Shift in V1 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*') 
```
...
ggplot(data = cor_037V2.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 1B: Shift in V2 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*')
```
...
ggMarginal(placebo_2.0[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 1B: Pain inclusion threshold = 0',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_2.3[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 1B: Pain inclusion threshold = 3',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_2.4[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 1B: Pain inclusion threshold = 4',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_2.5[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 1B: Pain inclusion threshold = 5',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
shift_B <- cor_037V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(title = 'Scenario 1B',
       subtitle = 'Threshold 0:\nBASELINE = 6.1 (1.4), ENDPOINT = 6.1 (1.4), r = 0.34',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
...
# Scenario 1C: Inter-measurement correlation = 0.51
...
ggMarginal(ggplot(data = cor_051.base) +
               ...
               labs(title = 'Scenario 1C: Unconstained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggMarginal(ggplot(data = cor_051) +
               ...
               labs(title = 'Scenario 1C: Constrained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggplot(data = cor_051V1.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 1C: Shift in V1 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*')
```
...
ggplot(data = cor_051V2.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 1C: Shift in V2 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*') 
```
...
ggMarginal(placebo_3.0[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 1C: Pain inclusion threshold = 0',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_3.3[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 1C: Pain inclusion threshold = 3',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_3.4[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 1C: Pain inclusion threshold = 4',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_3.5[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 1C: Pain inclusion threshold = 5',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
shift_C <- cor_051V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(title = 'Scenario 1C',
       subtitle = 'Threshold 0:\nBASELINE = 6.1 (1.4), ENDPOINT = 6.1 (1.4), r = 0.49',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
  scale_x_continuous(breaks = 0:3,
                     labels = c(0, 3, 4, 5)) +
...
ggsave(filename = 'figures/figure-scenario-1-baseline-shift.png',
       plot = shifts,
       height = 7.5, 
       width = 21)
...
ggsave(filename = 'figures/figure-scenario-1-V1V2-difference.png',
       plot = diffs,
       height = 7.5, 
       width = 21)
```

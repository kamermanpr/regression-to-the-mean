...
subtitle: "Mean NRS pain rating of 6.2 at 0.5 correlation"
...
if(!dir.exists('figures/six.two_05')){
  dir.create('figures/six.two_05')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/six.two_05/')
```
...
ggMarginal(ggplot(data = six_1.base) +
               ...
               labs(subtitle = 'Mean = 6.2, SD = 1.2, cor = 0.5') +
...
ggMarginal(ggplot(data = six_1) +
               ...
               labs(subtitle = 'Mean = 6.2, SD = 1.2 (constrained), cor = 0.5') +
               scale_y_continuous(limits = c(-5, 15)) +
               scale_x_continuous(limits = c(-5, 15)) +
               theme(panel.grid = element_blank(),
                     plot.subtitle = element_text(size = 16)))
...
ggMarginal(placebo_1.0[, 1:3] %>% 
               ...
               labs(subtitle = 'Base model: Mean = 6.2, SD = 1.2, cor = 0.5; Cut-off: 0') +
...
ggMarginal(placebo_1.3[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(subtitle = 'Base model: Mean = 6.2, SD = 1.2, cor = 0.5; Cut-off: 3') +
               theme(legend.title = element_blank(),
                     legend.position = c(0.85, 0.15),
                     legend.background = element_rect(colour = '#000000',
                                                      size = 0.5),
...
ggMarginal(placebo_1.4[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(subtitle = 'Base model: Mean = 6.2, SD = 1.2, cor = 0.5; Cut-off: 4') +
               theme(legend.title = element_blank(),
                     legend.position = c(0.85, 0.15),
                     legend.background = element_rect(colour = '#000000',
                                                      size = 0.5),
...
ggMarginal(placebo_1.5[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(subtitle = 'Base model: Mean = 6.2, SD = 1.2, cor = 0.5; Cut-off: 5') +
               theme(legend.title = element_blank(),
                     legend.position = c(0.85, 0.15),
                     legend.background = element_rect(colour = '#000000',
                                                      size = 0.5),
...
ggMarginal(ggplot(data = six_2.base) +
               ...
               labs(subtitle = 'Mean = 6.2, SD = 1.7, cor = 0.5') +
               scale_y_continuous(limits = c(-5, 15)) +
               scale_x_continuous(limits = c(-5, 15)) +
               theme(panel.grid = element_blank(),
                     plot.subtitle = element_text(size = 16)))
...
ggMarginal(ggplot(data = six_2) +
               ...
               labs(subtitle = 'Mean = 6.2, SD = 1.7 (constrained), cor = 0.5') +
               scale_y_continuous(limits = c(-5, 15)) +
               scale_x_continuous(limits = c(-5, 15)) +
               theme(panel.grid = element_blank(),
                     plot.subtitle = element_text(size = 16)))
...
ggMarginal(placebo_2.3[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(subtitle = 'Base model: Mean = 6.2, SD = 1.7, cor = 0.5; Cut-off: 3') +
               theme(legend.title = element_blank(),
                     legend.position = c(0.85, 0.15),
                     legend.background = element_rect(colour = '#000000',
                                                      size = 0.5),
...
ggMarginal(placebo_2.4[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(subtitle = 'Base model: Mean = 6.2, SD = 1.7, cor = 0.5; Cut-off: 4') +
               theme(legend.title = element_blank(),
                     legend.position = c(0.85, 0.15),
                     legend.background = element_rect(colour = '#000000',
                                                      size = 0.5),
...
ggMarginal(placebo_2.5[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(subtitle = 'Base model: Mean = 6.2, SD = 1.7, cor = 0.5; Cut-off: 5') +
               theme(legend.title = element_blank(),
                     legend.position = c(0.85, 0.15),
                     legend.background = element_rect(colour = '#000000',
                                                      size = 0.5),
...
ggMarginal(ggplot(data = six_3.base) +
               ...
               labs(subtitle = 'Mean = 6.2, SD = 2.2, cor = 0.5') +
               scale_y_continuous(limits = c(-5, 15)) +
               scale_x_continuous(limits = c(-5, 15)) +
               theme(panel.grid = element_blank(),
                     plot.subtitle = element_text(size = 16)))
...
ggMarginal(ggplot(data = six_3) +
               ...
               labs(subtitle = 'Mean = 6.2, SD = 2.2 (constrained), cor = 0.5') +
               scale_y_continuous(limits = c(-5, 15)) +
               scale_x_continuous(limits = c(-5, 15)) +
               theme(panel.grid = element_blank(),
                     plot.subtitle = element_text(size = 16)))
...
ggMarginal(placebo_3.3[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(subtitle = 'Base model: Mean = 6.2, SD = 2.2, cor = 0.5; Cut-off: 3') +
               theme(legend.title = element_blank(),
                     legend.position = c(0.85, 0.15),
                     legend.background = element_rect(colour = '#000000',
                                                      size = 0.5),
...
ggMarginal(placebo_3.4[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(subtitle = 'Base model: Mean = 6.2, SD = 2.2, cor = 0.5; Cut-off: 4') +
               theme(legend.title = element_blank(),
                     legend.position = c(0.85, 0.15),
                     legend.background = element_rect(colour = '#000000',
                                                      size = 0.5),
...
ggMarginal(placebo_3.5[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(subtitle = 'Base model: Mean = 6.2, SD = 2.2, cor = 0.5; Cut-off: 5') +
               theme(legend.title = element_blank(),
                     legend.position = c(0.85, 0.15),
                     legend.background = element_rect(colour = '#000000',
                                                      size = 0.5),

...
ggMarginal(ggplot(data = six_1.base) +
               ...
               labs(title = 'A: Unconstained',
                    caption = 'Parameters: Mean = 6.2, SD = 1.2, r = 0.5') +
...
shift_1 <- six_1V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(title = 'A',
       subtitle = 'Parameters: Mean = 6.2, SD = 1.2, r = 0.5',
       x = 'Baseline pain intensity threshold',
...
shift_2 <- six_2V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(title = 'B',
       subtitle = 'Parameters: Mean = 6.2, SD = 1.7, r = 0.5',
       x = 'Baseline pain intensity threshold',
       y = 'Mean pain score (0-10 rating scale)') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(4, 10)) +
...
ggMarginal(ggplot(data = six_3.base) +
               ...
               labs(title = 'A: Unconstrained',
                    caption = 'Parameters: Mean = 6.2, SD = 2.2, r = 0.5') +
               scale_y_continuous(limits = c(-5, 15)) +
               scale_x_continuous(limits = c(-5, 15)) +
               theme(plot.caption = element_text(size = 14)))
```
...
shift_3 <- six_3V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(title = 'C',
       subtitle = 'Parameters: Mean = 6.2, SD = 2.2, r = 0.5',
       x = 'Baseline pain intensity threshold',
       y = 'Mean pain score (0-10 rating scale)') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(4, 10)) +
...
ggsave('figures/6.2_0.5a.png', shift_4, width = 17, height = 7)

pp_4 <- pp_1 + pp_2 + pp_3
ggsave('figures/6.2_0.5b.png', pp_4, width = 17, height = 7)
```

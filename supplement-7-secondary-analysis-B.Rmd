---
title: "Supplement 7: Secondary analysis B"
subtitle: "Mean pain rating of 3.7 (SD 0.8) at 0.26, 0.37, and 0.51 inter-measurement correlation"
...
if(!dir.exists('figures/supplement-7-secondary-analysis-B')){
  dir.create('figures/supplement-7-seconadry-analysis-B')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-7-secondary-analysis-B/')
```
...
Covariance matrices were generated for each of the three combinations of correlation (_r_ = 0.26, 0.37, or 0.51) and the SD (0.8) using the `cor2cov` function from the `MBESS` package[^4]. Then, each of the three covariance matrices was used to a generate random sample from a bivariate normal distribution (n = 1000 per sample) with a mean of 3.7. The samples were generated using the `mvrnorm` function from the `MASS` package[^5]. 
...
Generate a covariance matrix using an SD of 0.8 and correlation of _r_ = 0.26, 0.37, and 0.51.
...
# Generate the data
cor_026.base <- as.data.frame(mvrnorm(n = 1000, mu = c(3.7, 3.7), Sigma = cov_026))
...
ggMarginal(ggplot(data = cor_026.base) +
               ...
               labs(title = 'A: Unconstained',
                    caption = 'Population parameters: Mean = 3.7, SD = 0.8, r = 0.26') +
...
shift_A <- cor_026V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(subtitle = 'Population parameters: Mean = 3.7, SD = 0.8, r = 0.26',
       x = 'Baseline pain intensity inclusion threshold',
...
diff_A <- diff_all_1 %>% 
  ...
  scale_y_continuous(limits = c(-0.2, 2.5)); diff_A
```
...
# Generate the data
cor_037.base <- as.data.frame(mvrnorm(n = 1000, mu = c(3.7, 3.7), Sigma = cov_037))
...
ggMarginal(ggplot(data = cor_037.base) +
               ...
               labs(title = 'A: Unconstained',
                    caption = 'Population parameters: Mean = 3.7, SD = 0.8, r = 0.37') +
               scale_y_continuous(limits = c(-5, 15),
                                  breaks = c(0, 5, 10)) +
               scale_x_continuous(limits = c(-5, 15),
                                  breaks = c(0, 5, 10)) +
...
shift_B <- cor_037V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(subtitle = 'Population parameters: Mean = 3.7, SD = 0.8, r = 0.37',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain score (0-10 rating scale)') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(3, 10)) +
...
diff_B <- diff_all_1 %>% 
  ...
  labs(subtitle = 'Population parameters: Mean = 3.7, SD = 0.8, r = 0.37',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean difference (V1 - V2)') +
  scale_y_continuous(limits = c(-0.2, 2.5)); diff_B
```
...
# Generate the data
cor_051.base <- as.data.frame(mvrnorm(n = 1000, mu = c(3.7, 3.7), Sigma = cov_051))
...
ggMarginal(ggplot(data = cor_051.base) +
               ...
               labs(title = 'A: Unconstained',
                    caption = 'Population parameters: Mean = 3.7, SD = 0.8, r = 0.51') +
               scale_y_continuous(limits = c(-5, 15),
                                  breaks = c(0, 5, 10)) +
               scale_x_continuous(limits = c(-5, 15),
                                  breaks = c(0, 5, 10)) +
...
shift_C <- cor_051V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(subtitle = 'Population parameters: Mean = 3.7, SD = 0.8, r = 0.51',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain score (0-10 rating scale)') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(3, 10)) +
...
diff_C <- diff_all_1 %>% 
  ...
  labs(subtitle = 'Population parameters: Mean = 3.7, SD = 0.8, r = 0.51',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean difference (V1 - V2)') +
  scale_y_continuous(limits = c(-0.2, 2.5)); diff_C
```
...
ggsave(filename = 'figures/figure-baseline-shift-2B.png',
       plot = shifts,
       height = 7, 
       width = 21)
...
ggsave(filename = 'figures/figure-V1V2-difference-2B.png',
       plot = diffs,
       height = 7, 
       width = 21)
```

...
if(!dir.exists('figures/supplement-3-scenario-1')){
  dir.create('figures/supplement-3-scenario-1')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-3-scenario-1/')
```
...
shift_A <- cor_026V1.df %>% 
  ...
  labs(title = 'Scenario 1A',
       subtitle = 'Threshold 0: V1 = 6.1 (1.6), V2 = 6.0 (1.7), r = 0.21',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
...
shift_B <- cor_037V1.df %>% 
  ...
  labs(title = 'Scenario 1B', 
       subtitle = 'Threshold 0: V1 = 6.0 (1.6), V2 = 6.0 (1.6), r = 0.32',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(5, 10)) +
...
shift_C <- cor_051V1.df %>% 
  ...
  labs(title = 'Scenario 1C',
       subtitle = 'Threshold 0: V1 = 6.1 (1.6), V2 = 6.1 (1.7), r = 0.5',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(5, 10)) +

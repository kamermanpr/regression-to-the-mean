...
ggMarginal(ggplot(data = six_1.base) +
               ...
               labs(title = 'A: Unconstained',
                    caption = 'Parameters: Mean = 6.2, SD = 1.2, Cor = 0.2') +
...
pp_1 <- diff_all_1 %>% 
  ...
  geom_point(shape = 21,
             ...
             size = 8) +
  labs(title = 'A',
       subtitle = 'Parameters: Mean = 6.2, SD = 1.2, Cor = 0.2',
       x = 'Baseline pain intensity threshold',
...
ggMarginal(ggplot(data = six_2.base) +
               ...
               labs(title = 'A: Unconstrained',
                    caption = 'Parameters: Mean = 6.2, SD = 1.7, Cor = 0.2') +
               scale_y_continuous(limits = c(-5, 15)) +
               scale_x_continuous(limits = c(-5, 15)) +
               theme(plot.caption = element_text(size = 14)))
...
pp_2 <- diff_all_2 %>% 
  ...
  geom_point(shape = 21,
             ...
             size = 8) +
  labs(title = 'B',
       subtitle = 'Parameters: Mean = 6.2, SD = 1.7, Cor = 0.2',
       x = 'Baseline pain intensity threshold',
       y = 'Mean difference (V1 - V2)') +
...
ggMarginal(ggplot(data = six_3.base) +
               ...
               labs(title = 'A: Unconstrained',
                    caption = 'Parameters: Mean = 6.2, SD = 2.2, Cor = 0.2') +
               scale_y_continuous(limits = c(-5, 15)) +
               scale_x_continuous(limits = c(-5, 15)) +
               theme(plot.caption = element_text(size = 14)))
...
pp_3 <- diff_all_3 %>% 
  ...
  geom_point(shape = 21,
             ...
             size = 8) +
  labs(title = 'C',
       subtitle = 'Parameters: Mean = 6.2, SD = 2.2, Cor = 0.2',
       x = 'Baseline pain intensity threshold',
       y = 'Mean difference (V1 - V2)') +
...
```{r pub_plot}
pp_4 <- pp_1 + pp_2 + pp_3
ggsave('figures/6.2_0.2.png', pp_4, width = 17, height = 7)
```

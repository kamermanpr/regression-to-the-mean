...
subtitle: "Mean pain rating of 6.2 at 0.8 correlation"
...
ggMarginal(ggplot(data = six_1.base) +
               ...
               annotate(geom = 'text', x = -5, y = mean(six_1.base$V2) + 1.5, hjust = 0,
                        label = str_glue("Mean = {round(mean(six_1.base$V2), 2)}")) +
               annotate(geom = 'text', x = -5, y = mean(six_1.base$V2) + 0.75, hjust = 0,
                        label = str_glue("SD = {round(sd(six_1.base$V2),2)}")) +
               annotate(geom = 'text', x = mean(six_1.base$V1) + 0.2, y = -4, hjust = 0,
                        label = str_glue("Mean = {round(mean(six_1.base$V1), 2)}")) +
               annotate(geom = 'text', x = mean(six_1.base$V1) + 0.2, y = -4.75, hjust = 0,
                        label = str_glue("SD = {round(sd(six_1.base$V1), 2)}")) +
               labs(title = 'Unconstained',
                    caption = 'Parameters: Mean = 6.2, SD = 1.2, Cor = 0.8') +
...
ggMarginal(ggplot(data = six_1) +
               ...
               annotate(geom = 'text', x = -5, y = mean(six_1$V2) + 1.5, hjust = 0,
                        label = str_glue("Mean = {round(mean(six_1$V2), 2)}")) +
               annotate(geom = 'text', x = -5, y = mean(six_1$V2) + 0.75, hjust = 0,
                        label = str_glue("SD = {round(sd(six_1$V2),2)}")) +
               annotate(geom = 'text', x = mean(six_1$V1) + 0.2, y = -4, hjust = 0,
                        label = str_glue("Mean = {round(mean(six_1$V1), 2)}")) +
               annotate(geom = 'text', x = mean(six_1$V1) + 0.2, y = -4.75, hjust = 0,
...
pp_1 <- diff_all_1 %>% 
  ...
  geom_point(shape = 21,
             ...
             size = 8) +
  labs(title = 'A',
       subtitle = 'Parameters: Mean = 6.2, SD = 1.2, Cor = 0.8',
...
ggMarginal(ggplot(data = six_2.base) +
               ...
               annotate(geom = 'text', x = -5, y = mean(six_2.base$V2) + 1.5, hjust = 0,
                        label = str_glue("Mean = {round(mean(six_2.base$V2), 2)}")) +
               annotate(geom = 'text', x = -5, y = mean(six_2.base$V2) + 0.75, hjust = 0,
                        label = str_glue("SD = {round(sd(six_2.base$V2),2)}")) +
               annotate(geom = 'text', x = mean(six_2.base$V1) + 0.2, y = -4, hjust = 0,
                        label = str_glue("Mean = {round(mean(six_2.base$V1), 2)}")) +
               annotate(geom = 'text', x = mean(six_2.base$V1) + 0.2, y = -4.75, hjust = 0,
                        label = str_glue("SD = {round(sd(six_2.base$V1), 2)}")) +
               labs(title = 'Unconstrained',
                    caption = 'Parameters: Mean = 6.2, SD = 1.7, Cor = 0.8') +
               scale_y_continuous(limits = c(-5, 15)) +
               scale_x_continuous(limits = c(-5, 15)))
...
ggMarginal(ggplot(data = six_2) +
               ...
               annotate(geom = 'text', x = -5, y = mean(six_2$V2) + 1.5, hjust = 0,
                        label = str_glue("Mean = {round(mean(six_2$V2), 2)}")) +
               annotate(geom = 'text', x = -5, y = mean(six_2$V2) + 0.75, hjust = 0,
                        label = str_glue("SD = {round(sd(six_2$V2),2)}")) +
               annotate(geom = 'text', x = mean(six_2$V1) + 0.2, y = -4, hjust = 0,
                        label = str_glue("Mean = {round(mean(six_2$V1), 2)}")) +
               annotate(geom = 'text', x = mean(six_2$V1) + 0.2, y = -4.75, hjust = 0,
...
pp_2 <- diff_all_2 %>% 
  ...
  geom_point(shape = 21,
             ...
             size = 8) +
  labs(title = 'B',
       subtitle = 'Parameters: Mean = 6.2, SD = 1.7, Cor = 0.8',
       x = 'Baseline pain intensity threshold',
       y = 'Mean difference (V1 - V2)') +
...
ggMarginal(ggplot(data = six_3.base) +
               ...
               annotate(geom = 'text', x = -5, y = mean(six_3.base$V2) + 1.5, hjust = 0,
                        label = str_glue("Mean = {round(mean(six_3.base$V2), 2)}")) +
               annotate(geom = 'text', x = -5, y = mean(six_3.base$V2) + 0.75, hjust = 0,
                        label = str_glue("SD = {round(sd(six_3.base$V2),2)}")) +
               annotate(geom = 'text', x = mean(six_3.base$V1) + 0.2, y = -4, hjust = 0,
                        label = str_glue("Mean = {round(mean(six_3.base$V1), 2)}")) +
               annotate(geom = 'text', x = mean(six_3.base$V1) + 0.2, y = -4.75, hjust = 0,
                        label = str_glue("SD = {round(sd(six_3.base$V1), 2)}")) +
               labs(title = 'Unconstrained',
                    caption = 'Parameters: Mean = 6.2, SD = 2.2, Cor = 0.8') +
               scale_y_continuous(limits = c(-5, 15)) +
               scale_x_continuous(limits = c(-5, 15)))
...
ggMarginal(ggplot(data = six_3) +
               ...
               annotate(geom = 'text', x = -5, y = mean(six_3$V2) + 1.5, hjust = 0,
                        label = str_glue("Mean = {round(mean(six_3$V2), 2)}")) +
               annotate(geom = 'text', x = -5, y = mean(six_3$V2) + 0.75, hjust = 0,
                        label = str_glue("SD = {round(sd(six_3$V2),2)}")) +
               annotate(geom = 'text', x = mean(six_3$V1) + 0.2, y = -4, hjust = 0,
                        label = str_glue("Mean = {round(mean(six_3$V1), 2)}")) +
               annotate(geom = 'text', x = mean(six_3$V1) + 0.2, y = -4.75, hjust = 0,
...
pp_3 <- diff_all_3 %>% 
  ...
  geom_point(shape = 21,
             ...
             size = 8) +
  labs(title = 'C',
       subtitle = 'Parameters: Mean = 6.2, SD = 2.2, Cor = 0.8',
       x = 'Baseline pain intensity threshold',
       y = 'Mean difference (V1 - V2)') +
...
```{r pub_plot}
pp_4 <- pp_1 + pp_2 + pp_3
ggsave('figures/6.2_0.8.png', pp_4, width = 17, height = 7)
```

---
title: "Supplement 5: Secondary analysis 2A"
subtitle: "Mean pain rating of 3.7 (SD 1.7) at 0.26, 0.37, 0.51 correlation"
...
if(!dir.exists('figures/supplement-5-secondary-analysis-2A')){
  dir.create('figures/supplement-5-secondary-analysis-2A')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-5-secondary-analysis-2A/')
```
...
ggsave(filename = 'figures/figure_3_shift1A.png',
       plot = shifts,
       height = 7, 
       width = 21)
...
ggsave(filename = 'figures/figure_3_diff1A.png',
       plot = diffs,
       height = 7, 
       width = 21)
```

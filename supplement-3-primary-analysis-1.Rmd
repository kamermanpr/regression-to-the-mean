---
title: "Supplement 3: Primary analysis A"
subtitle: "Mean pain rating of 6.2 (SD 1.7) at 0.26, 0.37, and 0.51 inter-measurement correlation"
...
if(!dir.exists('figures/supplement-3-primary-analysis-A')){
  dir.create('figures/supplement-3-primary-analysis-A')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-3-primary-analysis-A/')
```
...
shift_A <- cor_026V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(subtitle = 'Population parameters: Mean = 6.2, SD = 1.7, r = 0.26',
       x = 'Baseline pain intensity inclusion threshold',
...
shift_B <- cor_037V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(subtitle = 'Population parameters: Mean = 6.2, SD = 1.7, r = 0.37',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain score (0-10 rating scale)') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(4, 10)) +
...
shift_C <- cor_051V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(subtitle = 'Population parameters: Mean = 6.2, SD = 1.7, r = 0.51',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain score (0-10 rating scale)') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(4, 10)) +
...
ggsave(filename = 'figures/figure-baseline-shift-1A.png',
       plot = shifts,
       height = 7, 
       width = 21)
...
ggsave(filename = 'figures/figure-V1V2-difference-1A.png',
       plot = diffs,
       height = 7, 
       width = 21)
```

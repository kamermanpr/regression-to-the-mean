---
title: "Supplement 3: Primary analysis 1A"
subtitle: "Mean pain rating of 6.2 (SD 1.7) at 0.26, 0.37, 0.51 correlation"
...
if(!dir.exists('figures/supplement-3-primary-analysis-1A')){
  dir.create('figures/supplement-3-primary-analysis-1A')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-3-primary-analysis-1A/')
```
...
ggsave(filename = 'figures/figure_2_shift1A.png',
       plot = shifts,
       height = 7, 
       width = 21)
...
ggsave(filename = 'figures/figure_2_diff1A.png',
       plot = diffs,
       height = 7, 
       width = 21)
```

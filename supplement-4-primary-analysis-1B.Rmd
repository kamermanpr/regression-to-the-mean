---
title: "Supplement 4: Primary analysis 1B"
subtitle: "Mean pain rating of 6.2 (SD 0.8) at 0.26, 0.37, 0.51 correlation"
...
if(!dir.exists('figures/supplement-4-primary-analysis-1B')){
  dir.create('figures/supplement-4-primary-analysis-1B')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-4-primary-analysis-1B/')
```
...
ggsave(filename = 'figures/figure_2_shift1B.png',
       plot = shifts,
       height = 7, 
       width = 21)
...
ggsave(filename = 'figures/figure_2_diff1B.png',
       plot = diffs,
       height = 7, 
       width = 21)
```

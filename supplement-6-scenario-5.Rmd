---
title: "Supplement 7: Scenario 5"
subtitle: "Mean pain intensity of 6.7 (SD 1.7) at 0.26, 0.37, and 0.51 inter-measurement correlation"
...
if(!dir.exists('figures/supplement-7-scenario-5')){
  dir.create('figures/supplement-7-scenario-5')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-7-scenario-5/')
```
...
A baseline inclusion threshold of 0 on an 11-point NRS (i.e., no inclusion threshold) was used as a "control". In addition to the control threshold, three baseline pain intensity inclusion thresholds were selected based on the data listed in the supplementary materials of Finnerup and colleagues$^1$. The three thresholds were: pain intensity $\geq$ 4 (71% of listed studies), pain intensity $\geq$ 3 (12% of listed studies), and pain intensity $\geq$ 5 (11% of listed studies). Data from the three simulated datasets (mean = 6.7, SD = 1.7, correlation = 0.26, 0.37, 0.51) were each modelled under each of the four baseline pain intensity inclusion thresholds. 
...
- _r_ = 0.26 (Scenario 5A)

- _r_ = 0.37 (Scenario 5B)

- _r_ = 0.51 (Scenario 5C)
...
# Scenario 5A: Inter-measurement correlation = 0.26
...
# Generate the data
cor_026.base <- as.data.frame(mvrnorm(n = 1000, mu = c(6.7, 6.7), Sigma = cov_026))
...
ggMarginal(ggplot(data = cor_026.base) +
               ...
               labs(title = 'Scenario 5A: Unconstained',
...
ggMarginal(ggplot(data = cor_026) +
               ...
               labs(title = 'Scenario 5A: Constrained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
## Sample size after contraining data
...
ggplot(data = cor_026V1.df) +
    ...
    labs(title = 'Scenario 5A: Shift in V1 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
...
ggplot(data = cor_026V2.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 5A: Shift in V2 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*') 
```
...
ggMarginal(placebo_1.0[, 1:3] %>% 
               ...
               labs(title = 'Scenario 5A: Pain inclusion threshold = 0',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
...
ggMarginal(placebo_1.3[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 5A: Pain inclusion threshold = 3',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_1.4[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 5A: Pain inclusion threshold = 4',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_1.5[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 5A: Pain inclusion threshold = 5',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
shift_A <- cor_026V1.df %>% 
  ...
  geom_point(shape = 21,
             size = 8) +
  labs(title = 'Scenario 5A',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity',
       subtitle = 'Threshold 0: V1 = 6.5 (1.6), V2 = 6.5 (1.6), r = 0.2') +
...
diff_A <- diff_all_1 %>% 
  ...
  scale_y_continuous(limits = c(-0.2, 1.5)); diff_A
```

\newpage

# Scenario 5B: Inter-measurement correlation = 0.37
...
# Generate the data
cor_037.base <- as.data.frame(mvrnorm(n = 1000, mu = c(6.7, 6.7), Sigma = cov_037))
...
ggMarginal(ggplot(data = cor_037.base) +
               ...
               labs(title = 'Scenario 5B: Unconstained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggMarginal(ggplot(data = cor_037) +
               ...
               labs(title = 'Scenario 5B: Constrained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggplot(data = cor_037V1.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 5B: Shift in V1 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*') 
```
...
ggplot(data = cor_037V2.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 5B: Shift in V2 mean pain intensity',
         caption = 'Population parameters: Mean = 6.7, SD = 1.7, r = 0.37',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*')
```
...
ggMarginal(placebo_2.0[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 5B: Pain inclusion threshold = 0',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_2.3[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 5B: Pain inclusion threshold = 3',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_2.4[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 5B: Pain inclusion threshold = 4',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_2.5[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 5B: Pain inclusion threshold = 5',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
shift_B <- cor_037V1.df %>% 
  ...
  aes(y = mean,
      x = cutoff2,
      fill= time) +
  geom_hline(yintercept = 6.49,
             linetype = 2) +
  geom_point(shape = 21,
             size = 8) +
  labs(title = 'Scenario 5B',
       subtitle = 'Threshold 0: V1 = 6.5 (1.6), V2 = 6.5 (1.6), r = 0.31',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(5, 10)) +
...
diff_B <- diff_all_1 %>% 
  ...
  labs(title = 'Scenario 5B',
       ...
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean difference (V1 - V2)') +
  scale_y_continuous(limits = c(-0.2, 1.5)); diff_B
```

\newpage

# Scenario 5C: Inter-measurement correlation = 0.51
...
# Generate the data
cor_051.base <- as.data.frame(mvrnorm(n = 1000, mu = c(6.7, 6.7), Sigma = cov_051))
...
ggMarginal(ggplot(data = cor_051.base) +
               ...
               labs(title = 'Scenario 5C: Unconstained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggMarginal(ggplot(data = cor_051) +
               ...
               labs(title = 'Scenario 5C: Constrained',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               scale_y_continuous(limits = c(-5, 15),
...
ggplot(data = cor_051V1.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 5C: Shift in V1 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*')
```
...
ggplot(data = cor_051V2.df) +
    ...
    scale_y_continuous(limits = c(5, 10),
                       breaks = c(0, 2, 4, 6, 8, 10)) +
    labs(title = 'Scenario 5C: Shift in V2 mean pain intensity',
         caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
         x = 'Baseline pain intensity inclusion threshold',
         y = 'Mean pain intensity*')
```
...
ggMarginal(placebo_3.0[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 5C: Pain inclusion threshold = 0',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_3.3[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 5C: Pain inclusion threshold = 3',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_3.4[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 5C: Pain inclusion threshold = 4',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
ggMarginal(placebo_3.5[, 1:3] %>% 
               ...
               scale_fill_manual(values = pal) +
               scale_colour_manual(values = pal) +
               labs(title = 'Scenario 5C: Pain inclusion threshold = 5',
                    caption = '*Pain rated on a 0 to 10 numerical pain rating scale',
                    x = 'V1*',
                    y = 'V2*') +
               theme(legend.title = element_blank(),
...
shift_C <- cor_051V1.df %>% 
  ...
  aes(y = mean,
      x = cutoff2,
      fill= time) +
  geom_hline(yintercept = 6.47,
             linetype = 2) +
  geom_point(shape = 21,
             size = 8) +
  labs(title = 'Scenario 5C',
       subtitle = 'Threshold 0: V1 = 6.5 (1.6), V2 = 6.5 (1.6), r = 0.44',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
  scale_x_continuous(breaks = 0:5) +
  scale_y_continuous(limits = c(5, 10)) +
...
diff_C <- diff_all_1 %>% 
  ...
  labs(title = 'Scenario 5C',
       ...
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean difference (V1 - V2)') +
  scale_y_continuous(limits = c(-0.2, 1.5)); diff_C
```
...
ggsave(filename = 'figures/figure-scenario-5-baseline-shift.png',
       plot = shifts,
       height = 7, 
       width = 21)
...
ggsave(filename = 'figures/figure-scenario-5-V1V2-difference.png',
       plot = diffs,
       height = 7, 
       width = 21)
```

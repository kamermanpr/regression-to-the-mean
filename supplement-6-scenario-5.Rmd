...
if(!dir.exists('figures/supplement-6-scenario-5')){
  dir.create('figures/supplement-6-scenario-5')  
} 

opts_chunk$set(fig.height = 8,
               fig.width = 8,
               fig.path = 'figures/supplement-6-scenario-5/')
```
...
A baseline inclusion threshold of 0 on an 11-point NRS (i.e., no inclusion threshold) was used as a "control". In addition to the control threshold, three baseline pain intensity inclusion thresholds were selected based on the data listed in the supplementary materials of Finnerup and colleagues$^1$. The three thresholds were: pain intensity $\geq$ 4 (71% of listed studies), pain intensity $\geq$ 3 (12% of listed studies), and pain intensity $\geq$ 5 (11% of listed studies). Data from the three simulated datasets (mean = 6.7, SD = 1.7, correlation = 0.26, 0.37, 0.51) were each modelled under each of the three baseline pain intensity inclusion thresholds, and when there was no threshold. 
...
shift_A <- cor_026V1.df %>% 
  ...
  labs(title = 'Scenario 5A',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity',
       subtitle = 'Threshold 0\nBASELINE = 6.5 (1.6), ENDPOINT = 6.5 (1.6), r = 0.2') +
...
shift_B <- cor_037V1.df %>% 
  ...
  labs(title = 'Scenario 5B',
       subtitle = 'Threshold 0:\nBASELINE = 6.5 (1.6), ENDPOINT = 6.5 (1.6), r = 0.31',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
...
shift_C <- cor_051V1.df %>% 
  ...
  labs(title = 'Scenario 5C',
       subtitle = 'Threshold 0:\nBASELINE= 6.5 (1.6), ENDPOINT = 6.5 (1.6), r = 0.44',
       x = 'Baseline pain intensity inclusion threshold',
       y = 'Mean pain intensity') +
  scale_x_continuous(breaks = 0:3,
                     labels = c(0, 3, 4, 5)) +
...
shifts <- shift_A2 + shift_B2 + shift_C2 + 
  plot_layout(ncol = 3)
